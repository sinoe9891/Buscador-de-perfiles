...
<nav style="height: 120px;padding-top: 10px; padding-bottom: 10px;">
    <div class="nav-wrapper container">
    <a href="#!" class="brand-logo center">
        <img height="100px" class"responsive-img" src="img/logo.png">
      ...
      <ul class="left hide-on-med-and-down">
        <li class="dropdown-button" href="https://www.zamorano.edu/admisiones/porque-zamorano/" data-activates="dropdown1" ><a href="https://www.zamorano.edu/admisiones">Admisiones</a></li>
          <ul id="dropdown1" class="dropdown-content">
            <li><a href="#!">¿Por qué elegir ZAMORANO?</a></li>
            <li><a href="https://www.zamorano.edu/admisiones/examenes-de-admision/">Exámenes de admisión</a></li>
            <li class="divider"></li>
            <li><a href="https://www.zamorano.edu/admisiones/costos-admisiones/">Costos</a></li>
          </ul>
